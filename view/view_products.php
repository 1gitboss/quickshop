...
<body>
    ...
    <div class="container p-5 my-5 bg-dark text-white">
        <div class="row justify-content-between">
            <div class="col-auto">
                <a class="btn btn-success" href="view_orders.php" style="color:White">Orders</a>
            </div>
            <div class="col-auto">
                <a class="btn btn-info" href="view_order_details.php" style="color:blue-black">Order details</a>
            </div>
        </div>
    </div>
    </div>
