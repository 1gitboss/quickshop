...
(3, 1, 1, 'Bag', 50, 'A very nice bag that has all the features you can think a bag should have', '../assets/img/brown-bag.jpg', NULL),
(4, 1, 1, 'Shoe', 50, 'A very nice shoe that has all the features you can think a shoe should have', '../assets/img/shoe.jpg', NULL),
(5, 1, 1, 'Blue blouse', 27.5, 'A Blue blouse for outing', '../assets/img/blue-blouse.jpg', NULL),
(6, 1, 2, 'Green Outfit', 10.99, 'A simple plain white t-shirt, comfortable and stylish.', '../assets/img/green-outfit.jpeg', 't-shirt, white, casual'),
(7, 1, 2, 'Blue Denim Jeans', 29.99, 'Classic blue denim jeans, perfect for everyday wear.', '../assets/img/trousers.jpg', 'jeans, blue, denim, casual'),
(8, 1, 2, 'polo dress', 39.99, 'Cozy black hoodie, ideal for chilly days.', '../assets/img/polo-dress.jpg', 'hoodie, black, casual, warm'),
(9, 1, 2, 'Red Flannel Shirt', 25.99, 'Trendy red flannel shirt, perfect for layering.', '../assets/img/hoodie.jpg', 'shirt, red, flannel, trendy'),
(10, 1, 2, 'Pink dress', 19.99, 'Comfortable grey sweatpants for lounging or workouts.', '../assets/img/pink-dress.jpg', 'sweatpants, grey, casual, comfy');
